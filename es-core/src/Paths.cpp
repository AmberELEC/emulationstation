...
// EmuElec paths
	...
	mEmulationStationPath = getExePath();
	mUserEmulationStationPath = Utils::FileSystem::getCanonicalPath(getHomePath() + "/.emulationstation");
	mLogPath = mEmulationStationPath + "/logs";
	mThemesPath = mEmulationStationPath + "/themes";
	mUserThemesPath = mEmulationStationPath + "/themes";
	...
	mSystemConfFilePath = "/storage/.config/distribution/config/distribution.conf";
